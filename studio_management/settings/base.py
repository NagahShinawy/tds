...
SUPPORTED_LANGUAGES = os.environ.get('SUPPORTED_LANGUAGES', 'en,ar')
language_codes = [code.strip() for code in SUPPORTED_LANGUAGES.split(',')]

LANGUAGES = [(code, code) for code in language_codes]

LOCALE_PATHS = [
    os.path.join(BASE_DIR, 'apps', 'core', 'locale'),
    os.path.join(BASE_DIR, 'apps', 'profiles', 'locale'),
]
